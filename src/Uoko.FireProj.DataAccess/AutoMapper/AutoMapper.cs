...
namespace Uoko.FireProj.DataAccess.AutoMapper
{
    public class AutoMapper
    {
        public static void MapperRegister()
        {
            ...
            Mapper.CreateMap<DomainResourceDto, DomainResource>();

            Mapper.CreateMap<Server, ServerDto>();
            Mapper.CreateMap<ServerDto, Server>();


            Mapper.CreateMap<TaskInfo, TaskDetailDto>();
        }
    }
}
